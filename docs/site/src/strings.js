...
const strings = {
  en: {
    ...
    DOCUMENTATION_CONTENT: "<p>The technical documentation generated by <strong>Doxygen</strong> for Backy's source code can be found <a href='https://felsocim.github.io/Backy/technical/html/index.html' target='_blank'>here</a>.</p>",
    GET_BACKY_HEADER: "Download",
    GET_BACKY_CONTENT: "<p>Backy can be acquired either by downloading the binary file which suits your target operating system or by downloading Backy's sources and compiling it by yourself. In both cases, please, refer to the <a href='https://github.com/felsocim/Backy/releases' target='_blank'>releases section</a> in the Backy's GitHub repository.</p>",
  ...
  fr: {
    ...
    DOCUMENTATION_CONTENT: "<p>La documentation technique complète du code source de Backy générée par <strong>Doxygen</strong> est disponible en suivant <a href='https://felsocim.github.io/Backy/technical/html/index.html' target='_blank'>ce lien</a>.</p>",
    GET_BACKY_HEADER: "Téléchargement",
    GET_BACKY_CONTENT: "<p>Vous pouvez acquérir Backy soit en téléchargeant le fichier binaire compatible avec votre système d'exploitation destinataire ou en téléchargeant les fichiers sources de Backy et en les compilant par vous-mêmes. Dans les deux cas veuillez consulter la <a href='https://github.com/felsocim/Backy/releases' target='_blank'>liste des versions publiées</a> de Backy dans son répertoire GitHub.</p>",
