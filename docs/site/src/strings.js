...
const strings = {
  en: {
    ...
    GET_BINARIES_CONTENT: "<h2>Windows® installer (64-bit)</h2><p>You can download the installer of the latest version of Backy which is <strong>1.0</strong> <a href='https://felsocim.github.io/Backy/download/Backy_v1.0_setup_x64.exe' target='_blank'>from here</a>.</p><h2>Linux® packages</h2><p>Linux® packages are not available yet. We are working on it :-)</p>",
  ...
  fr: {
    ...
    GET_BINARIES_CONTENT: "<h2>Installateur Windows® (64-bit)</h2><p>Vous pouvez télécharger l'installateur de la dernière version de Backy qui est la <strong>1.0</strong> <a href='https://felsocim.github.io/Backy/download/Backy_v1.0_setup_x64.exe' target='_blank'>à partir de ce lien</a>.</p><h2>Paquets Linux®</h2><p>Des paquets Linux® ne sont pas encore disponibles. On y travaille :-)</p>",
  ...
  sk: {
    ...
    GET_BINARIES_CONTENT: "<h2>Inštalátor Windows® (64-bitový)</h2><p>Môžete si stiahnuť inštalátor najnovšieho vydania Backyho, teda <strong>1.0</strong>, <a href='https://felsocim.github.io/Backy/download/Backy_v1.0_setup_x64.exe' target='_blank'>kliknutím na tento odkaz</a>.</p><h2>Balíky pre Linux®</h2><p>Balíky pre Linux® ešte nie sú dostupné. Pracujeme na tom :-)</p>",
